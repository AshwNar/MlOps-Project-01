...
class TrainPipeline:
    ...
    def start_data_validation(self,data_ingestion_artifact: DataIngestionArtifact)-> DataValidationArtifact:
        """
        this method of raining piipline calss is responsble for statring data validation component.
        """
        logging.info("Enterting the start_data_validation method of trainigpipeline calss")
        ...
        try:
            ...
            logging.info("performing the data validation opration")

            logging.info("" \
            "Exited the start_data_validation method of the taining pipeline calss ")
